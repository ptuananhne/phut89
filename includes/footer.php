...
?>
</div> <!-- Đóng thẻ .container từ header.php -->
</main> <!-- Đóng thẻ .main-content từ header.php -->
...
<!-- Nạp file JS chính của trang web -->
<script src="<?php echo BASE_URL; ?>/assets/js/main.js?v=<?php echo time(); // Cache busting 
                                                            ?>"></script>
</body>
